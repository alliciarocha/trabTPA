...
Neste trabalho prático, foi desenvolvido um código em Java que implementa listas encadeadas nos formatos ordenado e não ordenado, utilizando generics. O principal objetivo é analisar a complexidade computacional e o tempo de execução das operações de inserção e pesquisa, considerando especialmente o pior caso.
### 📂 O que Faz o Código
